    ...
    <div class="channel">
      ...
      <van-grid class="van-hairline--left">
        <van-grid-item  v-for="(item,index) in channels" :key="item.id">
          ...
          <van-icon @click="$emit('delChannel',item.id)" v-if="index && editing===true" class="btn" name="cross"></van-icon>
        </van-grid-item>
      </van-grid>
    </div>
    <div class="channel">
      ...
      <van-grid class="van-hairline--left">
        <van-grid-item v-for="channel in optionalAllChannels" :key="channel.id">
